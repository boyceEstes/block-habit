...
//        let expectedHabitsForDay = [IsCompletedHabit(habit: someHabit,  status: .incomplete)]
//        
//        // when
//        do {
...
//        let expectedHabitsForDay = [IsCompletedHabit(habit: someHabit,  status: .incomplete)]
//        let expectedHabitsForDay2 = [IsCompletedHabit(habit: someHabit,  status: .incomplete), IsCompletedHabit(habit: someHabit2,  status: .incomplete)]
//        
//        // when
//        do {
//            try await store.create(someHabit)
